 ...
 */
fractal.set('project.title', 'FaceToFace UI Component Library');

/*
 * Other project metadata.
 */
fractal.set('project.version', 'v1.0');
fractal.set('project.repository', 'https://github.com/AccentDesign/facetoface');
fractal.set('project.author', 'Accent Design');
